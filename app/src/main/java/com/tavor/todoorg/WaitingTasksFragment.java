...
public class WaitingTasksFragment extends Fragment implements TaskAdapter.ClickListener {
    ...
    public static WaitingTasksFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_waiting_tasks, container, false);
    ...
    public void onStart() {
        super.onStart();
        SyncParse dataMgr = new SyncParse(getContext(), ParseUser.getCurrentUser(),true);
        dataMgr.syncFromParseFirstTime();
        tasks = dataMgr.getWaitingTasks();
        ...
        if (tasks!=null)
        {
            ...
            {
                header.setText("Waiting Tasks: " + tasks.size());
            }
        }
        else
        {
